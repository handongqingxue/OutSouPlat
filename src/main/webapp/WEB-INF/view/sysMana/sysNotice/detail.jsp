...
<div class="layui-layout layui-layout-admin">
	...
	<div class="center_con_div" id="center_con_div">
		<div class="page_location_div">通知查询-通知详情</div>
		
		<div id="detail_div">
			<input type="hidden" id="id" name="id" value="${requestScope.sysNotice.id }"/>
			<table>
			  <tr>
			  ...
			  <tr>
				...
				<td class="td2">
					${requestScope.sysNotice.sendUserName }
				</td>
				<td class="td1" align="right">
					接收人
				</td>
				<td class="td2">
					${requestScope.sysNotice.receiveUserName }
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
				...
				<td class="td2">
					${requestScope.sysNotice.createTime }
				</td>
				<td class="td1" align="right">
					是否已读
				</td>
				<td class="td2">
					${requestScope.sysNotice.read?'已读':'未读' }
				</td>
			  </tr>
			</table>
		</div>
