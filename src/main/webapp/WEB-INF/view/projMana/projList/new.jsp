...
<div class="layui-layout layui-layout-admin">
	...
	<div class="center_con_div" id="center_con_div">
		<div class="page_location_div">项目列表-添加项目</div>
		...
		<div id="new_div">
			...
			<table>
			  <tr>
				...
				<td class="td2">
					<input type="text" class="name_inp" id="name" name="name" placeholder="请输入项目名称"/>
				</td>
				<td class="td1" align="right">
					开发语言
				</td>
				<td class="td2">
					<input type="text" class="deveLang_inp" id="deveLang" name="deveLang" placeholder="请输入开发语言"/>
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
				...
				<td class="td2">
					<input type="text" class="database_inp" id="database" name="database" placeholder="请输入数据库"/>
				</td>
				<td class="td1" align="right">
					开发工具
				</td>
				<td class="td2">
					<input type="text" class="deveTool_inp" id="deveTool" name="deveTool" placeholder="请输入开发工具"/>
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
				...
				<td class="td2">
					<textarea rows="6" cols="10" class="intro_inp" id="intro" name="intro" placeholder="请输入简介"></textarea>
				</td>
				<td class="td1" align="right">
					插图
				</td>
				<td class="td2">
					...
					<img class="illus_img" id="illus_img" alt="" src=""/>
				</td>
			  </tr>
			</table>
			</form>
